...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto;
namespace cosmos {
namespace crypto {
namespace secp256k1 {
class PrivKey;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cosmos::crypto::secp256k1::PrivKey* Arena::CreateMaybeMessage<::cosmos::crypto::secp256k1::PrivKey>(Arena*);
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PrivKey::set_key(ArgT0&& arg0, ArgT... args) {
...
inline void PrivKey::set_allocated_key(std::string* key) {
  if (key != nullptr) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto
