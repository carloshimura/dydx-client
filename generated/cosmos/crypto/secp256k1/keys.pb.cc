...
struct PrivKeyDefaultTypeInternal {
  PROTOBUF_CONSTEXPR PrivKeyDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PrivKeyDefaultTypeInternal _PrivKey_default_instance_;
}  // namespace secp256k1
}  // namespace crypto
}  // namespace cosmos
static ::_pb::Metadata file_level_metadata_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto = nullptr;

const uint32_t TableStruct_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, -1, sizeof(::cosmos::crypto::secp256k1::PrivKey)},
};
...
static ::_pbi::once_flag descriptor_table_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto = {
    false, false, 310, descriptor_table_protodef_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto,
    "cosmos/crypto/secp256k1/keys.proto",
    &descriptor_table_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto_once, descriptor_table_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto_deps, 2, 2,
    schemas, file_default_instances, TableStruct_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto::offsets,
    file_level_metadata_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto, file_level_enum_descriptors_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto(&descriptor_table_cosmos_2fcrypto_2fsecp256k1_2fkeys_2eproto);
namespace cosmos {
namespace crypto {
namespace secp256k1 {
...
inline void PrivKey::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
