...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2ftx_2fv1beta1_2ftx_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2ftx_2fv1beta1_2ftx_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cosmos_2ftx_2fv1beta1_2ftx_2eproto;
namespace cosmos {
namespace tx {
namespace v1beta1 {
class AuthInfo;
...
template<> ::cosmos::tx::v1beta1::AuxSignerData* Arena::CreateMaybeMessage<::cosmos::tx::v1beta1::AuxSignerData>(Arena*);
...
template<> ::cosmos::tx::v1beta1::SignDocDirectAux* Arena::CreateMaybeMessage<::cosmos::tx::v1beta1::SignDocDirectAux>(Arena*);
...
class AuxSignerData final :
 ...
 public:
  ...
  private:
  bool _internal_has_sign_doc() const;
  public:
  void clear_sign_doc();
...
void TxRaw::set_body_bytes(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.body_bytes_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TxRaw::set_allocated_body_bytes(std::string* body_bytes) {
  ...
  _impl_.body_bytes_.SetAllocated(body_bytes, GetArenaForAllocation());
...
void TxRaw::set_auth_info_bytes(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.auth_info_bytes_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TxRaw::set_allocated_auth_info_bytes(std::string* auth_info_bytes) {
  ...
  _impl_.auth_info_bytes_.SetAllocated(auth_info_bytes, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SignDocDirectAux::set_body_bytes(ArgT0&& arg0, ArgT... args) {
...
inline void SignDocDirectAux::set_allocated_body_bytes(std::string* body_bytes) {
  if (body_bytes != nullptr) {
...
// .google.protobuf.Any public_key = 2;
inline bool SignDocDirectAux::_internal_has_public_key() const {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SignDocDirectAux::set_chain_id(ArgT0&& arg0, ArgT... args) {
...
inline void SignDocDirectAux::set_allocated_chain_id(std::string* chain_id) {
  if (chain_id != nullptr) {
...
// .cosmos.tx.v1beta1.Tip tip = 6;
inline bool SignDocDirectAux::_internal_has_tip() const {
  return this != internal_default_instance() && _impl_.tip_ != nullptr;
}
...
inline ::PROTOBUF_NAMESPACE_ID::Any* TxBody::mutable_extension_options(int index) {
  ...
  return _impl_.extension_options_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PROTOBUF_NAMESPACE_ID::Any >*
...
inline const ::PROTOBUF_NAMESPACE_ID::Any& TxBody::_internal_extension_options(int index) const {
  return _impl_.extension_options_.Get(index);
}
...
inline ::PROTOBUF_NAMESPACE_ID::Any* TxBody::_internal_add_extension_options() {
  return _impl_.extension_options_.Add();
}
...
inline ::PROTOBUF_NAMESPACE_ID::Any* TxBody::mutable_non_critical_extension_options(int index) {
  ...
  return _impl_.non_critical_extension_options_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::PROTOBUF_NAMESPACE_ID::Any >*
...
inline const ::PROTOBUF_NAMESPACE_ID::Any& TxBody::_internal_non_critical_extension_options(int index) const {
  return _impl_.non_critical_extension_options_.Get(index);
}
...
inline ::PROTOBUF_NAMESPACE_ID::Any* TxBody::_internal_add_non_critical_extension_options() {
  return _impl_.non_critical_extension_options_.Add();
}
...
inline ::cosmos::tx::v1beta1::SignerInfo* AuthInfo::mutable_signer_infos(int index) {
  ...
  return _impl_.signer_infos_.Mutable(index);
}
...
inline const ::cosmos::tx::v1beta1::SignerInfo& AuthInfo::_internal_signer_infos(int index) const {
  return _impl_.signer_infos_.Get(index);
}
...
inline ::cosmos::tx::v1beta1::SignerInfo* AuthInfo::_internal_add_signer_infos() {
  return _impl_.signer_infos_.Add();
}
...
inline bool SignerInfo::_internal_has_mode_info() const {
  return this != internal_default_instance() && _impl_.mode_info_ != nullptr;
}
...
inline bool ModeInfo_Multi::_internal_has_bitarray() const {
  return this != internal_default_instance() && _impl_.bitarray_ != nullptr;
}
...
inline ::cosmos::tx::v1beta1::ModeInfo* ModeInfo_Multi::mutable_mode_infos(int index) {
  ...
  return _impl_.mode_infos_.Mutable(index);
}
...
inline const ::cosmos::tx::v1beta1::ModeInfo& ModeInfo_Multi::_internal_mode_infos(int index) const {
  return _impl_.mode_infos_.Get(index);
}
...
inline ::cosmos::base::v1beta1::Coin* Fee::mutable_amount(int index) {
  ...
  return _impl_.amount_.Mutable(index);
}
...
void Fee::set_payer(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.payer_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Fee::set_allocated_payer(std::string* payer) {
  ...
  _impl_.payer_.SetAllocated(payer, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void Fee::set_granter(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.granter_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Fee::set_allocated_granter(std::string* granter) {
  ...
  _impl_.granter_.SetAllocated(granter, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void Tip::set_tipper(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.tipper_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Tip::set_allocated_tipper(std::string* tipper) {
  ...
  _impl_.tipper_.SetAllocated(tipper, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AuxSignerData::set_address(ArgT0&& arg0, ArgT... args) {
...
inline void AuxSignerData::set_allocated_address(std::string* address) {
  if (address != nullptr) {
...
// .cosmos.tx.v1beta1.SignDocDirectAux sign_doc = 2;
inline bool AuxSignerData::_internal_has_sign_doc() const {
  return this != internal_default_instance() && _impl_.sign_doc_ != nullptr;
}
inline bool AuxSignerData::has_sign_doc() const {
  return _internal_has_sign_doc();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AuxSignerData::set_sig(ArgT0&& arg0, ArgT... args) {
...
inline void AuxSignerData::set_allocated_sig(std::string* sig) {
  if (sig != nullptr) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cosmos_2ftx_2fv1beta1_2ftx_2eproto
