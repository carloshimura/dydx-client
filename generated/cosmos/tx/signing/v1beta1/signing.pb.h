...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2ftx_2fsigning_2fv1beta1_2fsigning_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2ftx_2fsigning_2fv1beta1_2fsigning_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cosmos_2ftx_2fsigning_2fv1beta1_2fsigning_2eproto;
namespace cosmos {
namespace tx {
namespace signing {
namespace v1beta1 {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cosmos::tx::signing::v1beta1::SignatureDescriptor* Arena::CreateMaybeMessage<::cosmos::tx::signing::v1beta1::SignatureDescriptor>(Arena*);
template<> ::cosmos::tx::signing::v1beta1::SignatureDescriptor_Data* Arena::CreateMaybeMessage<::cosmos::tx::signing::v1beta1::SignatureDescriptor_Data>(Arena*);
template<> ::cosmos::tx::signing::v1beta1::SignatureDescriptor_Data_Multi* Arena::CreateMaybeMessage<::cosmos::tx::signing::v1beta1::SignatureDescriptor_Data_Multi>(Arena*);
template<> ::cosmos::tx::signing::v1beta1::SignatureDescriptor_Data_Single* Arena::CreateMaybeMessage<::cosmos::tx::signing::v1beta1::SignatureDescriptor_Data_Single>(Arena*);
template<> ::cosmos::tx::signing::v1beta1::SignatureDescriptors* Arena::CreateMaybeMessage<::cosmos::tx::signing::v1beta1::SignatureDescriptors>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cosmos {
namespace tx {
namespace signing {
...
constexpr SignMode SignMode_MAX = SIGN_MODE_EIP_191;
...
template <> struct is_proto_enum< ::cosmos::tx::signing::v1beta1::SignMode> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cosmos_2ftx_2fsigning_2fv1beta1_2fsigning_2eproto
