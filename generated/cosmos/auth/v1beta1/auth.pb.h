...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fauth_2fv1beta1_2fauth_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fauth_2fv1beta1_2fauth_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cosmos_2fauth_2fv1beta1_2fauth_2eproto;
namespace cosmos {
namespace auth {
namespace v1beta1 {
class BaseAccount;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cosmos::auth::v1beta1::BaseAccount* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::BaseAccount>(Arena*);
template<> ::cosmos::auth::v1beta1::ModuleAccount* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::ModuleAccount>(Arena*);
template<> ::cosmos::auth::v1beta1::ModuleCredential* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::ModuleCredential>(Arena*);
template<> ::cosmos::auth::v1beta1::Params* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::Params>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cosmos {
namespace auth {
namespace v1beta1 {
...
class ModuleAccount final :
 ...
 public:
  ...
  private:
  bool _internal_has_base_account() const;
  public:
...
class ModuleCredential final :
 ...
 public:
  ...
  void set_derivation_keys(int index, const void* value, size_t size);
  ...
  void add_derivation_keys(const void* value, size_t size);
...
void BaseAccount::set_address(ArgT0&& arg0, ArgT... args) {
...
inline void BaseAccount::set_allocated_address(std::string* address) {
  if (address != nullptr) {
...
// .google.protobuf.Any pub_key = 2 [(.gogoproto.jsontag) = "public_key,omitempty", (.amino.field_name) = "public_key"];
inline bool BaseAccount::_internal_has_pub_key() const {
...
// .cosmos.auth.v1beta1.BaseAccount base_account = 1 [(.gogoproto.embed) = true];
inline bool ModuleAccount::_internal_has_base_account() const {
  return this != internal_default_instance() && _impl_.base_account_ != nullptr;
}
inline bool ModuleAccount::has_base_account() const {
  return _internal_has_base_account();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ModuleAccount::set_name(ArgT0&& arg0, ArgT... args) {
...
inline void ModuleAccount::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
inline void ModuleAccount::set_permissions(int index, const char* value, size_t size) {
...
inline void ModuleAccount::add_permissions(const char* value, size_t size) {
...
ModuleAccount::mutable_permissions() {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ModuleCredential::set_module_name(ArgT0&& arg0, ArgT... args) {
...
inline void ModuleCredential::set_allocated_module_name(std::string* module_name) {
...
inline const std::string& ModuleCredential::_internal_derivation_keys(int index) const {
  return _impl_.derivation_keys_.Get(index);
}
...
inline std::string* ModuleCredential::mutable_derivation_keys(int index) {
  ...
  return _impl_.derivation_keys_.Mutable(index);
}
inline void ModuleCredential::set_derivation_keys(int index, const std::string& value) {
  _impl_.derivation_keys_.Mutable(index)->assign(value);
...
inline void ModuleCredential::set_derivation_keys(int index, std::string&& value) {
  _impl_.derivation_keys_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:cosmos.auth.v1beta1.ModuleCredential.derivation_keys)
}
...
inline void ModuleCredential::set_derivation_keys(int index, const void* value, size_t size) {
  _impl_.derivation_keys_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline std::string* ModuleCredential::_internal_add_derivation_keys() {
  return _impl_.derivation_keys_.Add();
}
inline void ModuleCredential::add_derivation_keys(const std::string& value) {
  _impl_.derivation_keys_.Add()->assign(value);
...
inline void ModuleCredential::add_derivation_keys(std::string&& value) {
  _impl_.derivation_keys_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:cosmos.auth.v1beta1.ModuleCredential.derivation_keys)
}
...
inline void ModuleCredential::add_derivation_keys(const void* value, size_t size) {
  _impl_.derivation_keys_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ModuleCredential::mutable_derivation_keys() {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cosmos_2fauth_2fv1beta1_2fauth_2eproto
