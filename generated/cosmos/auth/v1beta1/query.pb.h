...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fauth_2fv1beta1_2fquery_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fauth_2fv1beta1_2fquery_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cosmos_2fauth_2fv1beta1_2fquery_2eproto;
namespace cosmos {
namespace auth {
namespace v1beta1 {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cosmos::auth::v1beta1::AddressBytesToStringRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::AddressBytesToStringRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::AddressBytesToStringResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::AddressBytesToStringResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::AddressStringToBytesRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::AddressStringToBytesRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::AddressStringToBytesResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::AddressStringToBytesResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::Bech32PrefixRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::Bech32PrefixRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::Bech32PrefixResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::Bech32PrefixResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountAddressByIDRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountAddressByIDRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountAddressByIDResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountAddressByIDResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountInfoRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountInfoRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountInfoResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountInfoResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountsRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountsRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryAccountsResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryAccountsResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryModuleAccountByNameRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryModuleAccountByNameRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryModuleAccountByNameResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryModuleAccountByNameResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryModuleAccountsRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryModuleAccountsRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryModuleAccountsResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryModuleAccountsResponse>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryParamsRequest* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryParamsRequest>(Arena*);
template<> ::cosmos::auth::v1beta1::QueryParamsResponse* Arena::CreateMaybeMessage<::cosmos::auth::v1beta1::QueryParamsResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cosmos {
namespace auth {
namespace v1beta1 {
...
class Bech32PrefixResponse final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_bech32_prefix(ArgT0&& arg0, ArgT... args);
  std::string* mutable_bech32_prefix();
  PROTOBUF_NODISCARD std::string* release_bech32_prefix();
  void set_allocated_bech32_prefix(std::string* bech32_prefix);
  private:
  const std::string& _internal_bech32_prefix() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_bech32_prefix(const std::string& value);
...
class AddressBytesToStringRequest final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_address_bytes(ArgT0&& arg0, ArgT... args);
  std::string* mutable_address_bytes();
  PROTOBUF_NODISCARD std::string* release_address_bytes();
  void set_allocated_address_bytes(std::string* address_bytes);
  private:
  const std::string& _internal_address_bytes() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_address_bytes(const std::string& value);
...
class AddressBytesToStringResponse final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_address_string(ArgT0&& arg0, ArgT... args);
  std::string* mutable_address_string();
  PROTOBUF_NODISCARD std::string* release_address_string();
  void set_allocated_address_string(std::string* address_string);
  private:
  const std::string& _internal_address_string() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_address_string(const std::string& value);
...
class QueryAccountAddressByIDRequest final :
 ...
 public:
  ...
  PROTOBUF_DEPRECATED int64_t id() const;
  PROTOBUF_DEPRECATED void set_id(int64_t value);
  private:
...
// .cosmos.base.query.v1beta1.PageRequest pagination = 1;
inline bool QueryAccountsRequest::_internal_has_pagination() const {
...
// .cosmos.base.query.v1beta1.PageResponse pagination = 2;
inline bool QueryAccountsResponse::_internal_has_pagination() const {
  return this != internal_default_instance() && _impl_.pagination_ != nullptr;
}
...
void QueryAccountRequest::set_address(ArgT0&& arg0, ArgT... args) {
...
inline void QueryAccountRequest::set_allocated_address(std::string* address) {
  if (address != nullptr) {
...
// .google.protobuf.Any account = 1 [(.cosmos_proto.accepts_interface) = "cosmos.auth.v1beta1.AccountI"];
inline bool QueryAccountResponse::_internal_has_account() const {
...
// .cosmos.auth.v1beta1.Params params = 1 [(.gogoproto.nullable) = false];
inline bool QueryParamsResponse::_internal_has_params() const {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void QueryModuleAccountByNameRequest::set_name(ArgT0&& arg0, ArgT... args) {
...
inline void QueryModuleAccountByNameRequest::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
// .google.protobuf.Any account = 1 [(.cosmos_proto.accepts_interface) = "cosmos.auth.v1beta1.ModuleAccountI"];
inline bool QueryModuleAccountByNameResponse::_internal_has_account() const {
  return this != internal_default_instance() && _impl_.account_ != nullptr;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Bech32PrefixResponse::set_bech32_prefix(ArgT0&& arg0, ArgT... args) {
 
 _impl_.bech32_prefix_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Bech32PrefixResponse::set_allocated_bech32_prefix(std::string* bech32_prefix) {
  if (bech32_prefix != nullptr) {
    
  } else {
    
  }
  _impl_.bech32_prefix_.SetAllocated(bech32_prefix, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AddressBytesToStringRequest::set_address_bytes(ArgT0&& arg0, ArgT... args) {
 
 _impl_.address_bytes_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void AddressBytesToStringRequest::set_allocated_address_bytes(std::string* address_bytes) {
  if (address_bytes != nullptr) {
    
  } else {
    
  }
  _impl_.address_bytes_.SetAllocated(address_bytes, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AddressBytesToStringResponse::set_address_string(ArgT0&& arg0, ArgT... args) {
 
 _impl_.address_string_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void AddressBytesToStringResponse::set_allocated_address_string(std::string* address_string) {
  if (address_string != nullptr) {
    
  } else {
    
  }
  _impl_.address_string_.SetAllocated(address_string, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AddressStringToBytesRequest::set_address_string(ArgT0&& arg0, ArgT... args) {
...
inline void AddressStringToBytesRequest::set_allocated_address_string(std::string* address_string) {
  if (address_string != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AddressStringToBytesResponse::set_address_bytes(ArgT0&& arg0, ArgT... args) {
...
inline void AddressStringToBytesResponse::set_allocated_address_bytes(std::string* address_bytes) {
  if (address_bytes != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void QueryAccountAddressByIDResponse::set_account_address(ArgT0&& arg0, ArgT... args) {
 
 _impl_.account_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void QueryAccountAddressByIDResponse::set_allocated_account_address(std::string* account_address) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void QueryAccountInfoRequest::set_address(ArgT0&& arg0, ArgT... args) {
...
inline void QueryAccountInfoRequest::set_allocated_address(std::string* address) {
  if (address != nullptr) {
...
// .cosmos.auth.v1beta1.BaseAccount info = 1;
inline bool QueryAccountInfoResponse::_internal_has_info() const {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cosmos_2fauth_2fv1beta1_2fquery_2eproto
