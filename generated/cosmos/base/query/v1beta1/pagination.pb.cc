...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto = nullptr;

const uint32_t TableStruct_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 11, -1, -1, sizeof(::cosmos::base::query::v1beta1::PageResponse)},
};
...
const char descriptor_table_protodef_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto = {
    false, false, 269, descriptor_table_protodef_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto,
    "cosmos/base/query/v1beta1/pagination.proto",
    &descriptor_table_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto::offsets,
    file_level_metadata_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto, file_level_enum_descriptors_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto(&descriptor_table_cosmos_2fbase_2fquery_2fv1beta1_2fpagination_2eproto);
namespace cosmos {
namespace base {
namespace query {
namespace v1beta1 {
...
uint8_t* PageRequest::_InternalSerialize(
  ...
  if (this->_internal_limit() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(3, this->_internal_limit(), target);
  }

  // bool count_total = 4;
  if (this->_internal_count_total() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(4, this->_internal_count_total(), target);
  }

  // bool reverse = 5;
  if (this->_internal_reverse() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_reverse(), target);
  }
