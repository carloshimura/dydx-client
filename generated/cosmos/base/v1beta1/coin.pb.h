...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fbase_2fv1beta1_2fcoin_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fbase_2fv1beta1_2fcoin_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cosmos_2fbase_2fv1beta1_2fcoin_2eproto;
namespace cosmos {
namespace base {
namespace v1beta1 {
class Coin;
...
template<> ::cosmos::base::v1beta1::DecCoin* Arena::CreateMaybeMessage<::cosmos::base::v1beta1::DecCoin>(Arena*);
template<> ::cosmos::base::v1beta1::DecProto* Arena::CreateMaybeMessage<::cosmos::base::v1beta1::DecProto>(Arena*);
template<> ::cosmos::base::v1beta1::IntProto* Arena::CreateMaybeMessage<::cosmos::base::v1beta1::IntProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cosmos {
namespace base {
namespace v1beta1 {
...
class IntProto final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_int_(ArgT0&& arg0, ArgT... args);
  std::string* mutable_int_();
  PROTOBUF_NODISCARD std::string* release_int_();
  void set_allocated_int_(std::string* int_);
  private:
  const std::string& _internal_int_() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_int_(const std::string& value);
...
class DecProto final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_dec(ArgT0&& arg0, ArgT... args);
  std::string* mutable_dec();
  PROTOBUF_NODISCARD std::string* release_dec();
  void set_allocated_dec(std::string* dec);
  private:
  const std::string& _internal_dec() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_dec(const std::string& value);
...
void Coin::set_denom(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.denom_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Coin::set_allocated_denom(std::string* denom) {
  ...
  _impl_.denom_.SetAllocated(denom, GetArenaForAllocation());
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DecCoin::set_denom(ArgT0&& arg0, ArgT... args) {
...
inline void DecCoin::set_allocated_denom(std::string* denom) {
  if (denom != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DecCoin::set_amount(ArgT0&& arg0, ArgT... args) {
...
inline void DecCoin::set_allocated_amount(std::string* amount) {
  if (amount != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void IntProto::set_int_(ArgT0&& arg0, ArgT... args) {
 
 _impl_.int__.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void IntProto::set_allocated_int_(std::string* int_) {
  if (int_ != nullptr) {
    
  } else {
    
  }
  _impl_.int__.SetAllocated(int_, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DecProto::set_dec(ArgT0&& arg0, ArgT... args) {
 
 _impl_.dec_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void DecProto::set_allocated_dec(std::string* dec) {
  if (dec != nullptr) {
    
  } else {
    
  }
  _impl_.dec_.SetAllocated(dec, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cosmos_2fbase_2fv1beta1_2fcoin_2eproto
