...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_5fproto_2fcosmos_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_5fproto_2fcosmos_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cosmos_5fproto_2fcosmos_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cosmos_proto::InterfaceDescriptor* Arena::CreateMaybeMessage<::cosmos_proto::InterfaceDescriptor>(Arena*);
template<> ::cosmos_proto::ScalarDescriptor* Arena::CreateMaybeMessage<::cosmos_proto::ScalarDescriptor>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cosmos_proto {
...
enum ScalarType : int {
  ...
  SCALAR_TYPE_BYTES = 2,
  ScalarType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ScalarType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool ScalarType_IsValid(int value);
constexpr ScalarType ScalarType_MIN = SCALAR_TYPE_UNSPECIFIED;
constexpr ScalarType ScalarType_MAX = SCALAR_TYPE_BYTES;
...
inline bool ScalarType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ScalarType* value) {
...
class ScalarDescriptor final :
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable std::atomic<int> _field_type_cached_byte_size_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr name_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr description_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
...
void InterfaceDescriptor::set_name(ArgT0&& arg0, ArgT... args) {
...
inline void InterfaceDescriptor::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void InterfaceDescriptor::set_description(ArgT0&& arg0, ArgT... args) {
...
inline void InterfaceDescriptor::set_allocated_description(std::string* description) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ScalarDescriptor::set_name(ArgT0&& arg0, ArgT... args) {
...
inline void ScalarDescriptor::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ScalarDescriptor::set_description(ArgT0&& arg0, ArgT... args) {
...
inline void ScalarDescriptor::set_allocated_description(std::string* description) {
  if (description != nullptr) {
...
inline ::cosmos_proto::ScalarType ScalarDescriptor::_internal_field_type(int index) const {
  return static_cast< ::cosmos_proto::ScalarType >(_impl_.field_type_.Get(index));
}
...
inline void ScalarDescriptor::set_field_type(int index, ::cosmos_proto::ScalarType value) {
  _impl_.field_type_.Set(index, value);
...
ScalarDescriptor::field_type() const {
  // @@protoc_insertion_point(field_list:cosmos_proto.ScalarDescriptor.field_type)
  return _impl_.field_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>*
ScalarDescriptor::_internal_mutable_field_type() {
  return &_impl_.field_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>*
ScalarDescriptor::mutable_field_type() {
...
template <> struct is_proto_enum< ::cosmos_proto::ScalarType> : ::std::true_type {};
template <>
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cosmos_5fproto_2fcosmos_2eproto
