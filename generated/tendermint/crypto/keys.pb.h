...
inline void PublicKey::set_ed25519(ArgT0&& arg0, ArgT... args) {
  ...
  _impl_.sum_.ed25519_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void PublicKey::set_allocated_ed25519(std::string* ed25519) {
  ...
  if (ed25519 != nullptr) {
    set_has_ed25519();
    _impl_.sum_.ed25519_.InitAllocated(ed25519, GetArenaForAllocation());
  }
...
inline void PublicKey::set_secp256k1(ArgT0&& arg0, ArgT... args) {
  ...
  _impl_.sum_.secp256k1_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void PublicKey::set_allocated_secp256k1(std::string* secp256k1) {
  ...
  if (secp256k1 != nullptr) {
    set_has_secp256k1();
    _impl_.sum_.secp256k1_.InitAllocated(secp256k1, GetArenaForAllocation());
  }
