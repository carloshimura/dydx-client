...
void Proof::set_leaf_hash(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.leaf_hash_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Proof::set_allocated_leaf_hash(std::string* leaf_hash) {
  ...
  _impl_.leaf_hash_.SetAllocated(leaf_hash, GetArenaForAllocation());
...
inline const std::string& Proof::_internal_aunts(int index) const {
  return _impl_.aunts_.Get(index);
}
...
inline void Proof::add_aunts(const void* value, size_t size) {
  _impl_.aunts_.Add()->assign(reinterpret_cast<const char*>(value), size);
