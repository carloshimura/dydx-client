...
inline bool BlockID::_internal_has_part_set_header() const {
  return this != internal_default_instance() && _impl_.part_set_header_ != nullptr;
}
...
inline void BlockID::clear_part_set_header() {
  if (GetArenaForAllocation() == nullptr && _impl_.part_set_header_ != nullptr) {
...
void Vote::set_validator_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.validator_address_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Vote::set_allocated_validator_address(std::string* validator_address) {
  ...
  _impl_.validator_address_.SetAllocated(validator_address, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline bool SignedHeader::_internal_has_commit() const {
  return this != internal_default_instance() && _impl_.commit_ != nullptr;
}
inline bool SignedHeader::has_commit() const {
  return _internal_has_commit();
}
inline void SignedHeader::clear_commit() {
  if (GetArenaForAllocation() == nullptr && _impl_.commit_ != nullptr) {
...
inline bool LightBlock::_internal_has_signed_header() const {
  return this != internal_default_instance() && _impl_.signed_header_ != nullptr;
}
...
inline void LightBlock::clear_signed_header() {
  if (GetArenaForAllocation() == nullptr && _impl_.signed_header_ != nullptr) {
...
inline bool LightBlock::_internal_has_validator_set() const {
  return this != internal_default_instance() && _impl_.validator_set_ != nullptr;
}
...
void TxProof::set_root_hash(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.root_hash_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
