...
#ifndef GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::dydxprotocol::subaccounts::PerpetualPosition* Arena::CreateMaybeMessage<::dydxprotocol::subaccounts::PerpetualPosition>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace dydxprotocol {
namespace subaccounts {
...
class PerpetualPosition final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_funding_index(ArgT0&& arg0, ArgT... args);
  std::string* mutable_funding_index();
  PROTOBUF_NODISCARD std::string* release_funding_index();
  void set_allocated_funding_index(std::string* funding_index);
  private:
  const std::string& _internal_funding_index() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_funding_index(const std::string& value);
...
void PerpetualPosition::set_quantums(ArgT0&& arg0, ArgT... args) {
...
inline void PerpetualPosition::set_allocated_quantums(std::string* quantums) {
  if (quantums != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PerpetualPosition::set_funding_index(ArgT0&& arg0, ArgT... args) {
 
 _impl_.funding_index_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void PerpetualPosition::set_allocated_funding_index(std::string* funding_index) {
  if (funding_index != nullptr) {
    
  } else {
    
  }
  _impl_.funding_index_.SetAllocated(funding_index, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto
