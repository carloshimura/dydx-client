...
PROTOBUF_CONSTEXPR PerpetualPosition::PerpetualPosition(
    ...
    /*decltype(_impl_.quantums_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.funding_index_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.perpetual_id_)*/0u
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct PerpetualPositionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR PerpetualPositionDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PerpetualPositionDefaultTypeInternal _PerpetualPosition_default_instance_;
}  // namespace subaccounts
}  // namespace dydxprotocol
static ::_pb::Metadata file_level_metadata_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto = nullptr;

const uint32_t TableStruct_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\014BH\332\336\037@github.com/dydxprotocol/v4-chain/"
  "protocol/dtypes.SerializableInt\310\336\037\000\022_\n\rf"
  "unding_index\030\003 \001(\014BH\332\336\037@github.com/dydxp"
  "rotocol/v4-chain/protocol/dtypes.Seriali"
  "zableInt\310\336\037\000B\?Z=github.com/dydxprotocol/"
...
static ::_pbi::once_flag descriptor_table_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto = {
    false, false, 405, descriptor_table_protodef_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto,
    "dydxprotocol/subaccounts/perpetual_position.proto",
    &descriptor_table_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto_once, descriptor_table_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto_deps, 1, 1,
    schemas, file_default_instances, TableStruct_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto::offsets,
    file_level_metadata_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto, file_level_enum_descriptors_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto(&descriptor_table_dydxprotocol_2fsubaccounts_2fperpetual_5fposition_2eproto);
namespace dydxprotocol {
namespace subaccounts {
...
PerpetualPosition::PerpetualPosition(const PerpetualPosition& from)
  ...
  if (!from._internal_quantums().empty()) {
    _this->_impl_.quantums_.Set(from._internal_quantums(), 
  ...
  if (!from._internal_funding_index().empty()) {
    _this->_impl_.funding_index_.Set(from._internal_funding_index(), 
      _this->GetArenaForAllocation());
  }
...
inline void PerpetualPosition::SharedCtor(
...
uint8_t* PerpetualPosition::_InternalSerialize(
  ...
  if (this->_internal_perpetual_id() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(1, this->_internal_perpetual_id(), target);
  }

  // bytes quantums = 2 [(.gogoproto.nullable) = false, (.gogoproto.customtype) = "github.com/dydxprotocol/v4-chain/protocol/dtypes.SerializableInt"];
  if (!this->_internal_quantums().empty()) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_quantums(), target);
  }

  // bytes funding_index = 3 [(.gogoproto.nullable) = false, (.gogoproto.customtype) = "github.com/dydxprotocol/v4-chain/protocol/dtypes.SerializableInt"];
  if (!this->_internal_funding_index().empty()) {
    target = stream->WriteBytesMaybeAliased(
        3, this->_internal_funding_index(), target);
  }
...
void PerpetualPosition::InternalSwap(PerpetualPosition* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.quantums_, lhs_arena,
      &other->_impl_.quantums_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.funding_index_, lhs_arena,
